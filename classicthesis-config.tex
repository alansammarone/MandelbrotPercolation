...
\newcommand{\myTitle}{An exploration classical and Mandelbrot percolation models \xspace}
\newcommand{\mySubtitle}{A numerical comparison of percolation models and properties \xspace}
...
\newcommand{\myTime}{Sep 2020\xspace}
